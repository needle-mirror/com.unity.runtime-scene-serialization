...
namespace Unity.RuntimeSceneSerialization.CodeGen
{
    ...
    {
        const string k_AssemblyExceptionsPath = "ProjectSettings/RuntimeSerializationAssemblyExceptions.txt";
        ...
        static HashSet<string> s_AssemblyExceptions;
        ...
        internal static void ClearExceptionCache()
        {
            s_AssemblyExceptions = null;
            s_NamespaceExceptions = null;
            s_TypeExceptions = null;
        }

        internal static HashSet<string> GetAssemblyExceptions()
        {
            return s_AssemblyExceptions ?? (s_AssemblyExceptions = File.Exists(k_AssemblyExceptionsPath)
                ? new HashSet<string>(File.ReadAllLines(k_AssemblyExceptionsPath))
                : new HashSet<string>());
        }
        ...
        {
            SaveExceptions(k_AssemblyExceptionsPath, s_AssemblyExceptions);
