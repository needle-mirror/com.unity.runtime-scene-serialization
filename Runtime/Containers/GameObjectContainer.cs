...
namespace Unity.RuntimeSceneSerialization
{
    public class GameObjectContainer
    {
        ...
        public GameObjectContainer(GameObject gameObject)
        {
            ...
            {
                PrefabMetadataContainer = new PrefabMetadataContainer(gameObject);
                return;
            }
#endif
            ...
            {
                PrefabMetadataContainer = new PrefabMetadataContainer(prefabMetadata);
                return;
            }
            ...
            foreach (var component in k_TempComponents)
            {
                ...
                if (component.GetType() != typeof(EditorMetadata) && (component.hideFlags & HideFlags.DontSave) != 0)
                    continue;
            ...
            foreach (Transform child in gameObject.transform)
            {
                ...
                m_Children.Add(new GameObjectContainer(childGameObject));
            }
        }

        internal void InstantiatePrefab(string prefabGuid)
        {
#if UNITY_EDITOR
            ...
            m_GameObject = AssetPack.TryInstantiatePrefab(prefabGuid, Parent, AssetPack.CurrentAssetPack);
            if (m_GameObject == null)
            {
        ...
        internal void FinalizePrefab(PrefabMetadataContainer metadataContainer)
        {
            ...
            EditorMetadata.SceneReferenceActions.Enqueue(() => { HandleOverrides(overrides); });
        }
        ...
        void HandleOverrides(List<RuntimePrefabPropertyOverride> overrides)
        {
            var root = m_GameObject.transform;
            ...
            PrefabMetadata.PostProcessOverrideList(overrides);
        }
    }
}
