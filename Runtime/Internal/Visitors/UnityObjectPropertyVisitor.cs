...
namespace Unity.RuntimeSceneSerialization.Internal
{
    ...
    /// </summary>
    abstract class UnityObjectPropertyVisitor :
        IPropertyBagVisitor,
        ...
        IDictionaryPropertyVisitor
    {
        ...
        protected UnityObjectPropertyVisitor(SerializationMetadata metadata)
        {
        ...
        {
            static void RegisterType<TContainer, TValue>(Property<TContainer, TValue> property = default, TContainer container = default, TValue value = default)
            {
                ((UnityObjectPropertyVisitor) default).IsExcluded(property, ref container, ref value);
                ((UnityObjectPropertyVisitor) default).VisitProperty(property, ref container, ref value);
            }
            ...
            internal static void RegisterCollection<TContainer, TCollection, TElement>(Property<TContainer, TCollection> property = default, TContainer container = default, TCollection value = default)
                where TCollection : ICollection<TElement>
            {
                ((UnityObjectPropertyVisitor) default).VisitCollection<TContainer, TCollection, TElement>(property, ref container, ref value);
            }
            ...
            internal static void RegisterList<TContainer, TList, TElement>(Property<TContainer, TList> property = default, TContainer container = default, TList value = default)
                where TList : IList<TElement>
            {
                ((UnityObjectPropertyVisitor) default).VisitList<TContainer, TList, TElement>(property, ref container, ref value);
            }
            ...
            internal static void RegisterSet<TContainer, TSet, TValue>(Property<TContainer, TSet> property = default, TContainer container = default, TSet value = default)
                where TSet : ISet<TValue>
            {
                ((UnityObjectPropertyVisitor) default).VisitSet<TContainer, TSet, TValue>(property, ref container, ref value);
            }
            ...
            internal static void RegisterDictionary<TContainer, TDictionary, TKey, TValue>(Property<TContainer, TDictionary> property = default, TContainer container = default, TDictionary value = default)
                where TDictionary : IDictionary<TKey, TValue>
            {
                ((UnityObjectPropertyVisitor) default).VisitDictionary<TContainer, TDictionary, TKey, TValue>(property, ref container, ref value);
