...
namespace Unity.RuntimeSceneSerialization.Prefabs
{
    ...
    public abstract class RuntimePrefabPropertyOverride
    {
        ...
        static readonly object[] k_GetOverridesArguments = new object[4];
#endif
...
#if UNITY_EDITOR
        static RuntimePrefabPropertyOverride CreateMultiple<TContainer>(SerializedProperty property,
            string rootPropertyPath, string transformPath, int componentIndex, ref bool hasNext, ref bool shouldIterate)
        ...
        static RuntimePrefabPropertyOverride Create<TContainer>(SerializedProperty property, string propertyPath,
            string transformPath, int componentIndex, ref bool hasNext, out bool shouldIterate) where TContainer : UnityObject
        {
            shouldIterate = true;
            switch (property.propertyType)
            {
                ...
                case SerializedPropertyType.Color:
                    var listOverride = CreateMultiple<TContainer>(property, propertyPath, transformPath,
                        componentIndex, ref hasNext, ref shouldIterate);
                ...
                case SerializedPropertyType.ObjectReference:
                    var objectReference = UnityObjectReference.GetReferenceForObject(property.objectReferenceValue);
                ...
                case SerializedPropertyType.ExposedReference:
                    var exposedReference = UnityObjectReference.GetReferenceForObject(property.exposedReferenceValue);
            ...
            do
            {
                ...
                if (property.prefabOverride)
                {
                    var propertyOverride = Create<TContainer>(property, property.propertyPath, transformPath,
                        componentIndex, ref hasNext, out shouldIterate);
