...
{
    public static class ReflectedMemberPropertyName
    {
    ...
    public class ReflectedExternalMemberProperty<TContainer, TValue> : Property<TContainer, TValue>
    {
        ...
        public ReflectedExternalMemberProperty(FieldInfo info, string name, string externalContainerType)
            : this(new FieldMember(info), name, externalContainerType) { }
        ...
        public ReflectedExternalMemberProperty(PropertyInfo info, string name, string externalContainerType)
            : this(new PropertyMember(info), name, externalContainerType) { }
